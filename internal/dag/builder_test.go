...
func TestDAGInsert(t *testing.T) {
	...
	// i3b is similar to i3 but expects default secret
	i3b := &v1beta1.Ingress{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "kuard",
			Namespace: "default",
	...
	i12g := &v1beta1.Ingress{
		ObjectMeta: metav1.ObjectMeta{
			...
			Namespace: "default",
			Annotations: map[string]string{
				"projectcontour.io/idle-timeout": "peanut",
			},
		},
		Spec: v1beta1.IngressSpec{
			Rules: []v1beta1.IngressRule{{
	...
	i12h := &v1beta1.Ingress{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "timeout",
			Namespace: "default",
			Annotations: map[string]string{
				"projectcontour.io/idle-timeout": "1m30s", // 90 seconds y'all
			},
		},
		Spec: v1beta1.IngressSpec{
			Rules: []v1beta1.IngressRule{{
	...
	i12i := &v1beta1.Ingress{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "timeout",
			Namespace: "default",
			Annotations: map[string]string{
				"projectcontour.io/idle-timeout": "infinite",
			},
		},
		Spec: v1beta1.IngressSpec{
			Rules: []v1beta1.IngressRule{{
	...
	i12j := &v1beta1.Ingress{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "timeout",
			Namespace: "default",
			Annotations: map[string]string{
				"projectcontour.io/max-grpc-timeout": "peanut",
			},
		},
		Spec: v1beta1.IngressSpec{
			Rules: []v1beta1.IngressRule{{
	...
	i12k := &v1beta1.Ingress{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "timeout",
			Namespace: "default",
			Annotations: map[string]string{
				"projectcontour.io/max-grpc-timeout": "1m30s", // 90 seconds y'all
			},
		},
		Spec: v1beta1.IngressSpec{
			Rules: []v1beta1.IngressRule{{
	...
	i12l := &v1beta1.Ingress{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "timeout",
			Namespace: "default",
			Annotations: map[string]string{
				"projectcontour.io/max-grpc-timeout": "infinite",
			},
		},
		Spec: v1beta1.IngressSpec{
			Rules: []v1beta1.IngressRule{{
	...
	// similar to ir1a with default tls
	...
	ir16g := &ingressroutev1.IngressRoute{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "example-com",
			Namespace: "default",
		},
	...
	ir16h := &ingressroutev1.IngressRoute{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "example-com",
			Namespace: "default",
		},
	...
	ir16i := &ingressroutev1.IngressRoute{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "example-com",
			Namespace: "default",
		},
	...
	tests := map[string]struct {
		...
		"insert service, secret then ingress w/ default tls": {
			kc: &KubernetesCache{
		...
		"insert service, secret then ingress w/ default tls override": {
			kc: &KubernetesCache{
				DefaultSecret: MetaOptions{
					Name:      "secret",
					Namespace: "other",
		...
		"insert ingressroute w/ invalid max grpc timeoutpolicy": {
			objs: []interface{}{
				ir16g,
				s1,
			},
		...
		"insert ingressroute w/ valid max grpc timeoutpolicy": {
			objs: []interface{}{
				ir16h,
				s1,
			},
		...
		"insert ingressroute w/ infinite max grpc timeoutpolicy": {
			objs: []interface{}{
				ir16i,
				s1,
			},
	...
	for name, tc := range tests {
		t.Run(name, func(t *testing.T) {
			builder := Builder{
				...
				Source: func() KubernetesCache {
					if tc.kc == nil {
						return KubernetesCache{
							FieldLogger: testLogger(t),
						}
					}
					tc.kc.FieldLogger = testLogger(t)
					return *tc.kc
				}(),
			}
